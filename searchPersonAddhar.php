...
if($_SESSION["login"] != 1)
    ...
    $addhar = $_POST['addhar'];     
    $sql = "select * from Person where p_addhar = '$addhar'";
...
###########contents of div goes here###########
        ...
        $pid = "select p_id from Person where p_addhar = '$addhar'";
        
        $result_addhar = mysqli_query($con, $pid);

        echo'<h3>Donation History</h3><br>';

        $sql_d = "select * from Donation where p_id = ($pid)"; 
        ...
        $sql_r = "select * from Receive where p_id = ($pid)";  
        ...
        echo 'Person with addhar: ' .$addhar .' not found!
        <br>Please Provide A Valid Addhar Number';
    }
